...
const Shipping = () => {
  ...
  const save = (e) => {
    e.preventDefault();
    const { name, address, phone, province, city, post, area } = state;
    if (name && address && phone && province && city && post && area) {
      setRes(true);
    }
  };
          ...
          <div className="w-full flex flex-wrap">
            <div className="w-[67%] md-lg:w-full">
              <div className="flex flex-col gap-3">
                <div className="bg-slate-200 p-6 shadow-sm rounded-md">
                  ...
                  {res && (
                    <div className="flex flex-col gap-1">
                      <h2 className="text-slate-600 font-semibold pb-2">
                        Deliver To {state.name} {state.address} {state.phone}{" "}
                ...
                {products.map((p, i) => (
                  <div key={i} className="flex bg-slate-200 p-4 flex-col gap-2">
              ...
              <div className="pl-3 md-lg:pl-0 md-lg:mt-5">
                <div className="bg-slate-400 p-3 text-slate-600 flex flex-col gap-3">
                  ...
                  <button
                    ...
                    className={`px-5 py-[6px] rounded-sm hover:shadow-orange-500/50 hover:shadow-lg ${

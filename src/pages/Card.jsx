...
import picJazz from "../assets/latest/2.jpg";
...
const Card = () => {
  ...
  return (
    <div>
      <Header />
      <div className="bg-[url('http://localhost:3000/shopCard.jpg')] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-center">
        <div className="absolute left-0 top-0 w-full h-full  bg-[#2422228a]">
          <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto">
            <div className="flex flex-col justify-center gap-1 items-center h-full w-full text-slate-400 ">
                  ...
                  <div className="flex flex-col gap-3">
                    <div className="bg-slate-400 p-4">
                      <h2 className="text-md text-slate-600 font-semibold">
                        Stock Music {card_products.length}
                      </h2>
                    </div>

                    {card_products.map((p, i) => (
                      <div className="flex bg-slate-200 p-4 flex-col gap-2">
                          ...
                          <div className="w-full flex flex-wrap ">
                            ...
                            <div className="flex justify-between w-5/12 sm:w-full sm:mt-3">
                              ...
                              <div className="flex gap-2 flex-col">
                                <div className="flex bg-slate-300 h-[30px] justify-center items-center text-xl">
                                  <div
                                    onClick={() => dec(p.quantity, pt._id)}
                                ...
                                <button
                                  ...
                                  className="px-5 py-[3px] bg-red-400 text-slate-200"
                                >
                                  Delete
                                </button>
                              </div>
              ...
              <div className="w-[33%] md-lg:w-full">
                <div className="pl-3 md-lg:pl-0 md-lg:mt-5">
                  {card_products.length > 0 && (
                    <div className="bg-slate-400 p-3 text-slate-600 flex flex-col gap-3">
                      <h2 className="text-xl font-bold">Order Summary</h2>
                      <div className="flex justify-between items-center">
                        <span>{buy_product_item} Records</span>
                        <span>${price}</span>
                      </div>
                      <div className="flex justify-between items-center">
                      ...
                      <div className="flex gap-2">
                        <input
                          className="w-full px-3 py-2 border border-slate-200 outline-0 focus:border-sky-400 rounded-md"
                          type="text"
                          placeholder="Voucher Coupon"
                        />
                        <button className="px-5 py-[1px] bg-slate-500 text-white rounded-sm text-sm">
                          Apply
                        </button>
                      </div>
                      <div className="flex justify-between items-center">
                      ...
                      <button
                        onClick={redirect}
                        className="px-5 py-[6px] rounded-sm hover:shadow-orange-500/50 hover:shadow-lg bg-orange-500 text-md text-black"
                      >

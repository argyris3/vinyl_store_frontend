    ...
    <div className="bg-white p-3 rounded-md">
      <div className="w-full flex">
        ...
        >
          ...
          <div className="w-full flex flex-col text-red-600 py-4 h-[400px] pr-3">
            {my_friends.map((f, i) => (
              <Link
              ...
              >
                <div className="w-[30px] h-[30px] rounded-full relative">
                  {activeSeller.some((c) => c.sellerId === f.fdId) && (
                    <div className="w-[10px] h-[10px] rounded-full bg-white absolute right-0 bottom-0"></div>
                  )}
            ...
            <div className="w-full h-full">
              <div className="flex justify-between gap-3 items-center text-slate-600 text-xl h-[50px]">
                ...
                <div
                  ...
                  className="w-[35px] h-[35px] hidden md-lg:flex cursor-pointer rounded-sm justify-center items-center bg-sky-900 text-white"
                >
                  <span>
                    {" "}
                    <FaList />

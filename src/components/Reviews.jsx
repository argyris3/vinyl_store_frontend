      ...
      <div className="flex gap-10 md-lg:flex-col">
        ...
        <div className="flex gap-2 flex-col py-4">
          <div className="flex justify-start items-center gap-5">
            ...
            <div className="w-[200px] h-[14px] bg-slate-400 relative">
              <div
                style={{
                  width: `${Math.floor(
                ...
                className="h-full bg-black w-[60%] "
              ></div>
            </div>
            <p className="text-sm text-slate-700 w-[0%]">
              {rating_review[0]?.sum}
            </p>
          </div>
          <div className="flex justify-start items-center gap-5">
            ...
            <div className="w-[200px] h-[14px] bg-slate-400 relative">
              <div
                ...
                className="h-full bg-black w-[70%] "
              ></div>
            </div>
            <p className="text-sm text-slate-700 w-[0%]">
              {" "}
          ...
          <div className="flex justify-start items-center gap-5">
            ...
            <div className="w-[200px] h-[14px] bg-slate-400 relative">
              <div
                ...
                className="h-full bg-black w-[20%] "
              ></div>
            </div>
            <p className="text-sm text-slate-700 w-[0%]">
              {" "}
          ...
          <div className="flex justify-start items-center gap-5">
            ...
            <div className="w-[200px] h-[14px] bg-slate-400 relative">
              <div
                ...
                className="h-full bg-black w-[10%] "
              ></div>
            </div>
            <p className="text-sm text-slate-700 w-[0%]">
              {" "}
          ...
          <div className="flex justify-start items-center gap-5">
            ...
            <p className="text-sm text-slate-700 w-[0%]"> 0</p>
          </div>
        </div>
      </div>

      <h2 className="text-slate-700 text-xl font-bold py-5 capitalize">
        record review: {totalReview}
      </h2>
      ...
      <div>
        {userInfo ? (
          <div className="flex flex-col gap-3">
            ...
            <form onSubmit={review_submit}>
              ...
              <div className="mt-2 mb-1 ">
                <button className="py-1 px-3 bg-indigo-400 text-white rounded-sm">
                  Submit
                </button>
              </div>
            </form>
          ...
          <div>
            <Link
              to="/login"
              className="py-1 px-5 bg-red-400 text-white rounded-sm"
            >
              Please Login..
            </Link>
          </div>
